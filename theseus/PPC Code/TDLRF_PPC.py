...
## I/O parameters.
stan_model = 'TDLRF'
PATH_NAME = '/usr/people/kmarr/THESIS/TDLRF.stan'
...
total_data.to_csv("all_PPC_TDLRF.csv")

total_waic = concat(total_waic)
total_waic.to_csv("all_TDLRF_MC.csv")

sums = concat(sums)
sums.to_csv("all_PPC_TDLRF_stanfit.csv")