...
## I/O parameters.
stan_model = 'P_hybrid'
PATH_NAME = '/usr/people/kmarr/THESIS/P_hybrid'
...
total_data.to_csv("all_PPC_P_hybrid.csv")

total_waic = concat(total_waic)
total_waic.to_csv("all_P_hyb_MC.csv")

sums = concat(sums)
sums.to_csv("all_PPC_P_hyb_stanfit.csv")