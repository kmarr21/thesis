...
model {    
    ...
    for (i in 1:T) {
        ...
        // Forgetting Process
        Q2[S2[i]+1, (1-Y2[i])+1] += eta_F * ( u - Q2[S2[i]+1, (1-Y2[i])+1] );
        Q2[(1-S2[i])+1, Y2[i]+1] += eta_F * ( u - Q2[(1-S2[i])+1, Y2[i]+1] );
        Q2[(1-S2[i])+1, (1-Y2[i])+1] += eta_F * ( u - Q2[(1-S2[i])+1, (1-Y2[i])+1] );
        ...
        Q1[Y1[i] + 1] += eta_1 * (lam * w * cr * deltaC + lam * (1-w) * deltaC);
