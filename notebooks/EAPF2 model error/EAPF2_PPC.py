...
## I/O parameters.
stan_model = 'EAPF2'
PATH_NAME = '/Users/kierstenmarr/Desktop/PPC_REPO/EAPF2'
...
total_data.to_csv("HY3_PPC_EAPF2.csv")

total_waic = concat(total_waic)
total_waic.to_csv("HY3_EAPF2_MC.csv")

sums = concat(sums)
sums.to_csv("HY3_PPC_EAPF2_stanfit.csv")